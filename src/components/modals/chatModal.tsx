...
export function ChatModal({
  ...
  return (
    <div
      className={[
        "fixed bottom-24 right-6 z-50 origin-bottom-right rounded-3xl border border-white/60 bg-white/95 shadow-2xl backdrop-blur transition-all duration-300 ease-out",
        isOpen
          ? "w-[calc(100vw-2rem)] max-w-[26rem] p-0 opacity-100 translate-y-0"
          : "pointer-events-none w-16 p-0 opacity-0 translate-y-2",
      ].join(" ")}
      aria-hidden={!isOpen}
    >
      <div className={isOpen ? "block" : "hidden"}>
        <div className="rounded-t-3xl border-b border-[var(--color-border)] bg-gradient-to-r from-[var(--color-primary-light)] to-white px-5 py-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-5">
          <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]/60 p-3">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-[var(--color-border)] bg-white px-3 py-2 text-sm text-[var(--color-secondary)] shadow-sm">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-[var(--color-border)] bg-white px-3 py-2.5 text-sm outline-none transition placeholder:text-[var(--color-text-secondary)]/80 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/15"
          ...
          <label className="block">
            ...
            <textarea
              ...
              className="w-full resize-y rounded-xl border border-[var(--color-border)] bg-white px-3 py-2.5 text-sm outline-none transition placeholder:text-[var(--color-text-secondary)]/80 focus:border-[var(--color-primary)] focus:ring-2 focus:ring-[var(--color-primary)]/15"
